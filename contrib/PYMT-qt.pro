...
RESOURCES += src/qt/PYMT.qrc src/qt/PYMT_locale.qrc

TRANSLATIONS += src/qt/locale/PYMT_bg.ts \
                src/qt/locale/PYMT_de.ts \
                src/qt/locale/PYMT_en.ts \
                src/qt/locale/PYMT_es.ts \
                src/qt/locale/PYMT_fi.ts \
                src/qt/locale/PYMT_fr.ts \
                src/qt/locale/PYMT_it.ts \
                src/qt/locale/PYMT_ja.ts \
                src/qt/locale/PYMT_pl.ts \
                src/qt/locale/PYMT_pt.ts \
                src/qt/locale/PYMT_ru.ts \
                src/qt/locale/PYMT_sk.ts \
                src/qt/locale/PYMT_sv.ts \
                src/qt/locale/PYMT_vi.ts \
                src/qt/locale/PYMT_zh_CN.ts \
                src/qt/locale/PYMT_zh_TW.ts
