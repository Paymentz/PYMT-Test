...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("PYMT Core PYMT-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  PYMT-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded PYMT transaction") + "\n" +
                               "  PYMT-tx [options] -create [commands]   " + _("Create hex-encoded PYMT transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded PYMT transaction
