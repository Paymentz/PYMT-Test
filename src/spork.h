...
// Copyright (c) 2016-2017 The PYMT developers
...
#define SPORK_3_SWIFTTX_BLOCK_FILTERING_DEFAULT 1536969600        //  September 15, 2018
#define SPORK_5_MAX_VALUE_DEFAULT 1000                            //  1000 PYMT
