...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* PYMT features */
        {"PYMT", "masternode", &masternode, true, true, false},
        {"PYMT", "listmasternodes", &listmasternodes, true, true, false},
        {"PYMT", "getmasternodecount", &getmasternodecount, true, true, false},
        {"PYMT", "masternodeconnect", &masternodeconnect, true, true, false},
        {"PYMT", "masternodecurrent", &masternodecurrent, true, true, false},
        {"PYMT", "masternodedebug", &masternodedebug, true, true, false},
        {"PYMT", "startmasternode", &startmasternode, true, true, false},
        {"PYMT", "createmasternodekey", &createmasternodekey, true, true, false},
        {"PYMT", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"PYMT", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"PYMT", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"PYMT", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"PYMT", "getmasternodescores", &getmasternodescores, true, true, false},
        {"PYMT", "mnbudget", &mnbudget, true, true, false},
        {"PYMT", "preparebudget", &preparebudget, true, true, false},
        {"PYMT", "submitbudget", &submitbudget, true, true, false},
        {"PYMT", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"PYMT", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"PYMT", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"PYMT", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"PYMT", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"PYMT", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"PYMT", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"PYMT", "checkbudgets", &checkbudgets, true, true, false},
        {"PYMT", "mnsync", &mnsync, true, true, false},
        {"PYMT", "spork", &spork, true, true, false},
        {"PYMT", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"PYMT", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use PYMTd, or the -server option to PYMT-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
                                               ...
                                               "for example: alertnotify=echo %%s | mail -s \"PYMT Alert\" admin@foo.com\n"),
...
{
    return "> PYMT-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:38010/\n";
}
