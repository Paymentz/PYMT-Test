...
#if defined(NDEBUG)
#error "PYMT cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "PYMTcore Signed Message:\n";
...
int64_t GetBlockValue(int nHeight)
{
	...
	else if (nHeight <= 151 && nHeight > 0) {
        nSubsidy = 1 * COIN;
    }
	else if (nHeight <= 21601 && nHeight > 151) {
        nSubsidy = 3 * COIN;
    }
	else if (nHeight <= 43201 && nHeight > 21601) {
        nSubsidy = 3.15 * COIN;
    }
	else if (nHeight <= 64801 && nHeight > 43201) {
        nSubsidy = 3.31 * COIN;
    }
	else if (nHeight <= 86401 && nHeight > 64801) {
        nSubsidy = 3.47 * COIN;
    }
	else if (nHeight <= 108001 && nHeight > 86401) {
        nSubsidy = 3.65 * COIN;
    }
	else if (nHeight <= 129601 && nHeight > 108001) {
        nSubsidy = 3.83 * COIN;
    }
	else if (nHeight <= 151201 && nHeight > 129601) {
        nSubsidy = 3.91 * COIN;
    }
	else if (nHeight <= 172801 && nHeight > 151201) {
        nSubsidy = 3.98 * COIN;
    }
	else if (nHeight <= 194401 && nHeight > 172801) {
        nSubsidy = 4.02 * COIN;
    }
	else if (nHeight <= 216001 && nHeight > 194401) {
        nSubsidy = 4.06 * COIN;
    }
	else if (nHeight <= 237601 && nHeight > 216001) {
        nSubsidy = 3.98 * COIN;
    }
	else if (nHeight <= 259201 && nHeight > 237601) {
        nSubsidy = 3.9 * COIN;
    }
	else if (nHeight <= 280801 && nHeight > 259201) {
        nSubsidy = 3.82 * COIN;
    }
	else if (nHeight <= 302401 && nHeight > 280801) {
        nSubsidy = 3.67 * COIN;
    }
	else if (nHeight <= 324001 && nHeight > 302401) {
        nSubsidy = 3.52 * COIN;
    }
	else if (nHeight <= 345601 && nHeight > 324001) {
        nSubsidy = 3.35 * COIN;
    }
	else if (nHeight <= 367201 && nHeight > 345601) {
        nSubsidy = 3.18 * COIN;
    }
	else if (nHeight <= 388801 && nHeight > 367201) {
        nSubsidy = 3.02 * COIN;
    }
	else if (nHeight <= 410401 && nHeight > 388801) {
        nSubsidy = 2.87 * COIN;
    }
	else if (nHeight <= 432001 && nHeight > 410401) {
        nSubsidy = 2.73 * COIN;
    }
	else if (nHeight > 432001) {
        nSubsidy = 2.5 * COIN;
    }
    else {
        nSubsidy = 0 * COIN;
...
int64_t GetMasternodePayment(int nHeight, int64_t blockValue, int nMasternodeCount)
{
  ...
  if (nHeight <= 43200) {  // Special ROI for Crowdfunding participants
        ret = blockValue * 0.90;
    }
	else if (nHeight <= 64800 && nHeight > 43200) {
        ret = blockValue * 0.815;
    }
	else if (nHeight <= 86400 && nHeight > 64800) {
        ret = blockValue * 0.824;
    }
	else if (nHeight <= 108000 && nHeight > 86400) {
        ret = blockValue * 0.849;
    }
	else if (nHeight <= 129600 && nHeight > 108000) {
        ret = blockValue * 0.857;
    }
	else if (nHeight <= 151200 && nHeight > 129600) {
        ret = blockValue * 0.874;
    }
	else if (nHeight <= 172800 && nHeight > 151200) {
        ret = blockValue * 0.883;
    }
	else if (nHeight <= 216000 && nHeight > 172800) {
        ret = blockValue * 0.892;
    }
