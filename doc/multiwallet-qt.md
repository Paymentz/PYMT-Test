...
In order to support loading of multiple wallets in PYMT-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is PYMT.cpp.
...
Changes to PYMT.cpp
----------------------
PYMT.cpp is the entry point into PYMT-qt, and as such, will require some minor modifications to provide hooks for
