...
This mechanism has been integrated into Bitcore-Node-PYMT which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/PYMTproject/insight-api-PYMT#web-socket-api](https://github.com/PYMTproject/insight-api-PYMT#web-socket-api) 
* API: [https://github.com/PYMTproject/insight-api-PYMT#swifttx-transactions](https://github.com/PYMTproject/insight-api-PYMT#swifttx-transactions) 
...
By default, the PYMT Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the PYMT Core daemon:
